...
import { FolderOpen, AlertCircle, ChevronRight, CheckCircle, XCircle } from 'lucide-react';
...
const AllCategories = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                setLoading(true)
                const response = await axios.get("http://localhost:5000/api/v1/category/getAllCategories");
