...
const CategoryDetailsPage = () => {
  ...
  const fetchCategoryDetails = async () => {
    try {
      ...
      const res = await fetch(
        `http://localhost:5000/api/v1/category/getCategoryById/${id}`
      );
  ...
  const handleUpdateTaxRate = async () => {
    ...
    try {
      setActionLoading(true);
      const res = await fetch(
        `http://localhost:5000/api/v1/category/updateCategoryTaxRateAndProducts/${id}`,
        {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
  ...
  const handleDeactivateCategory = async () => {
    ...
    try {
      setActionLoading(true);
      const res = await fetch(
        `http://localhost:5000/api/v1/category/deactivateCategoryAndProducts/${id}`,
  ...
  const handleActivateCategory = async () => {
    ...
    try {
      setActionLoading(true);
      const res = await fetch(
        `http://localhost:5000/api/v1/category/activateCategoryAndProducts/${id}`,
        { method: 'PUT', headers: { 'Content-Type': 'application/json' } }
      );
      const response = await res.json();
      if (response.success) {
