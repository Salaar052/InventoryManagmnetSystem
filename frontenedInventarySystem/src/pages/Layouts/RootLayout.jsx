  ...
  return (
    <div className="flex h-screen bg-white overflow-hidden">
      ...
      <aside className="hidden lg:flex lg:w-64 bg-white border-r border-gray-200 flex-col flex-shrink-0">
        {/* Logo Section */}
        <div className="h-16 xl:h-20 flex items-center px-4 xl:px-6 border-b border-gray-200 flex-shrink-0">
          <h1 
        ...
        {/* Logout Section */}
        <div className="px-3 xl:px-4 py-4 xl:py-6 border-t border-gray-200 flex-shrink-0">
          <button 
